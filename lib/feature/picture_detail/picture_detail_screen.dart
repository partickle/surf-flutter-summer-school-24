...
import 'package:surf_flutter_summer_school_24/feature/picture_detail/picture_detail_model.dart';
import 'package:surf_flutter_summer_school_24/res/fonts/font_constants.dart';
import '../gallery/models/picture.dart';
      ...
      appBar: AppBar(
        ...
        title: ValueListenableBuilder<int>(
          ...
          builder: (context, currentIndex, _) {
            return Text(
              wm.parseDate(pictures[wm.currentPageNotifier.value].date),
